...
namespace Capa_Modelo_CierreContable
{
    public class Cls_CierreContable
    {
        ...
        // Insertar cierre contable completo
                                           ...
                                           string observaciones)
        {
            string query = @"
                ...
                (Cmp_Fecha_de_Cierre, Cmp_Periodo_de_Tiempo, Cmp_Fecha_Desde, Cmp_Fecha_Hasta,
                 Cmp_Movimiento_Debe, Cmp_Movimiento_Haber, Saldo_Anterior, Saldo_Final, Observaciones)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            using (OdbcCommand cmd = new OdbcCommand(query, conn))
            {
                ...
                cmd.Parameters.AddWithValue("", fechaDesde);
                cmd.Parameters.AddWithValue("", fechaHasta);
                cmd.Parameters.AddWithValue("", totalDebe);
                cmd.Parameters.AddWithValue("", totalHaber);
